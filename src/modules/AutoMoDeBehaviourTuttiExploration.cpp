/**
  * @file <src/modules/AutoMoDeBehaviourTuttiExploration.cpp>
  *
...
#include "AutoMoDeBehaviourTuttiExploration.h"
...
namespace argos {
	...
	AutoMoDeBehaviourTuttiExploration::AutoMoDeBehaviourTuttiExploration() {
		m_strLabel = "TuttiExploration";
	}

	/****************************************/
	/****************************************/

	AutoMoDeBehaviourTuttiExploration::AutoMoDeBehaviourTuttiExploration(AutoMoDeBehaviourTuttiExploration* pc_behaviour) {
	...
	AutoMoDeBehaviourTuttiExploration* AutoMoDeBehaviourTuttiExploration::Clone() {
		return new AutoMoDeBehaviourTuttiExploration(this);
	}

	/****************************************/
	/****************************************/

	void AutoMoDeBehaviourTuttiExploration::Init() {
		m_unTurnSteps = 0;
	...
	void AutoMoDeBehaviourTuttiExploration::ControlStep() {
	...
	void AutoMoDeBehaviourTuttiExploration::Reset() {
	...
	void AutoMoDeBehaviourTuttiExploration::ResumeStep() {
		m_bOperational = true;
	}
	...
	bool AutoMoDeBehaviourTuttiExploration::IsObstacleInFront(CCI_EPuckProximitySensor::SReading s_prox_reading) {
