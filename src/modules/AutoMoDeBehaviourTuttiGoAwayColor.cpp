...
#include "AutoMoDeBehaviourTuttiGoAwayColor.h"
...
namespace argos {
    ...
    AutoMoDeBehaviourTuttiGoAwayColor::AutoMoDeBehaviourTuttiGoAwayColor() {
        m_strLabel = "TuttiGoAwayColor";
	}

	/****************************************/
	/****************************************/

    AutoMoDeBehaviourTuttiGoAwayColor::AutoMoDeBehaviourTuttiGoAwayColor(AutoMoDeBehaviourTuttiGoAwayColor* pc_behaviour) {
    ...
    AutoMoDeBehaviourTuttiGoAwayColor* AutoMoDeBehaviourTuttiGoAwayColor::Clone() {
        return new AutoMoDeBehaviourTuttiGoAwayColor(this);
	}

	/****************************************/
	/****************************************/

    void AutoMoDeBehaviourTuttiGoAwayColor::ControlStep() {
    ...
    void AutoMoDeBehaviourTuttiGoAwayColor::Init() {
    ...
    void AutoMoDeBehaviourTuttiGoAwayColor::Reset() {
    ...
    void AutoMoDeBehaviourTuttiGoAwayColor::ResumeStep() {
		m_bOperational = true;
	}
}
