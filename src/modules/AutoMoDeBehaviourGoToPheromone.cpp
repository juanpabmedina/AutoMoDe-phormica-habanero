...
#include "AutoMoDeBehaviourGoToPheromone.h"
...
namespace argos {
    ...
    AutoMoDeBehaviourGoToPheromone::AutoMoDeBehaviourGoToPheromone() {
        m_strLabel = "GoToPheromone";
	}

	/****************************************/
	/****************************************/

    AutoMoDeBehaviourGoToPheromone::AutoMoDeBehaviourGoToPheromone(AutoMoDeBehaviourGoToPheromone* pc_behaviour) {
    ...
    AutoMoDeBehaviourGoToPheromone* AutoMoDeBehaviourGoToPheromone::Clone() {
        return new AutoMoDeBehaviourGoToPheromone(this);   // todo: check without *
	}

	/****************************************/
	/****************************************/

    void AutoMoDeBehaviourGoToPheromone::ControlStep() {
    ...
    void AutoMoDeBehaviourGoToPheromone::Init() {
        ...
        m_cColorReceiverParameter = GetColorParameter(6, false); // MAGENTA color
        // } else {
        //     LOGERR << "[FATAL] Missing parameter for the following behaviour:" << m_strLabel << std::endl;
        //     THROW_ARGOSEXCEPTION("Missing Parameter");
        // }
    ...
    void AutoMoDeBehaviourGoToPheromone::Reset() {
    ...
    void AutoMoDeBehaviourGoToPheromone::ResumeStep() {
		m_bOperational = true;
	}
}
